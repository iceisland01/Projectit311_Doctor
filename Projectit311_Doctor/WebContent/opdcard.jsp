...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
	<meta charset="UTF-8">
	<title>OPD CARD บันทึกประจำตัวผู้ป่วย</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light container">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	...
	<div class="container textside">
			<h3 style="text-align:center;">บันทึกประจำตัวผู้ป่วย</h3>
		<div class="row">
		  <div class="col-md-6">
		  	<form action="#" name="frmPC" method="post">
			  <fieldset class="scheduler-border">
			    <legend>ทำบัตรประจำตัวผู้ป่วย</legend>
			    <table id="patient-card" style="text-align:center;">
			    	<tr>
              <td>เลขที่บัตรประจำตัวประชาชน <input type="text" name="idcard">  <input type="button" value="ค้นหา"></td>
            </tr>
			    </table> 
          <p>ข้อมูลผู้ป่วย</p>
      ...
      <div class="col-md-6">
        ...
        <div  style="text-align:center;">
              ...
              <input type="button" class="btn btn-warning" value="ออกบัตร">
          </div>  
      </form>
      </div>
		</div>
