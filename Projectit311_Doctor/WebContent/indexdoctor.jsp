    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item ">
		...
		<div class=" container textside" >
			<h3 style="text-align:center;">สำหรับหมอ</h3>
      <center>
			<table>
				<tr>
            <td><img src="img/iconFinish/นัดหมาย.png" alt="logo"></td>
          <td><img src="img/iconFinish/รักษาพยาบาล.png" alt="logo"></td>			
				</tr>
			</table>
      </center>
		</div>
