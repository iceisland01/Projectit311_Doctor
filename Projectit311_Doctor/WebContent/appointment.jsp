...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
	...
	<meta charset="UTF-8">
	<title>นัดหมายผู้ป่วย </title>
	<style type="text/css" media="screen">
		#Patientappointment td {  
	  padding-bottom: 13px;
		}
		a.ex1 {
        margin-left:25px;
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link ex1" href="profiletEng.jsp">Doctor's Profile</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item ">
		...
		<div class="container textside">
			<h3 style="text-align:center;">นัดหมายผู้ป่วย</h3>
			<div class="row">
        <div class="col-md-4">
				<from action="#" name="frmPP" method="post">
				<fieldset class="scheduler-border">
		 <legend>ข้อมลการนัดหมาย</legend>
					<table id="Patientappointment">
					<tr>
            <td>รหัสการนัดหมาย <input type="text" name="idappoint"></td>
          </tr>
          <tr>
            <td>วันที่เดือนปีที่นัด <input type="date" name="dateapp"></td>
          </tr>
          <tr>
            <td>เวลานัด <input type="text" name="timeappoint"></td>
          </tr>
          <tr>
            <td>สาเหตุที่นัด <input type="text" name="seasonapp"></td>
          </tr>
					</table>
				</div>
		    ...
		    <div class="col-md-6">
        <fieldset class="scheduler-border">
        <legend >รายละเอียดการนัดหมาย</legend>
         ...
         <div  style="text-align:center;">
              ...
              <input type="button" class="btn btn-warning" value="พิมพ์ใบนัด">
          </div>  
			</div>
      </from>
		</div>
